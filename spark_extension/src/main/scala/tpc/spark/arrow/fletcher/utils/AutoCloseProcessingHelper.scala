...
object AutoCloseProcessingHelper {
  ...
  private class IteratorWrapper[T, U](
      private val predecessor: Iterator[T],
      private val proc: ClosableFunction[T, U]
  ) extends AutoCloseableIterator[U] {
